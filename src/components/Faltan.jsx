...
export default function Faltan() {
  ...
  return (
    ...
    "
    >
      <h2 className="md:text-xl lg:text-2xl" data-aos="fade-up">
        FALTAN
      </h2>
      {tiempo ? (
        <div
          className="flex text-[2.5rem] md:text-[3.5rem] lg:text-[4rem] gap-1 font-normal"
          data-aos="zoom-in"
          data-aos-delay="200"
        >
      ...
      <h2
        className="pt-1 md:text-xl lg:text-2xl"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        PARA CELEBRAR
